    ...
    <>
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className="px-3 py-2 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 transition flex items-center gap-1"
